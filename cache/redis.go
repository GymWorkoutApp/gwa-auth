...
func (s *TokenStore) Create(info models.TokenInfo) (err error) {
	ct := time.Now()
...
func (s *TokenStore) getData(key string) (ti models.TokenInfo, err error) {
...
func (s *TokenStore) GetByCode(code string) (ti models.TokenInfo, err error) {
	ti, err = s.getData(code)
	return
}

// GetByAccess Use the access token for token information data
func (s *TokenStore) GetByAccess(access string) (ti models.TokenInfo, err error) {
...
func (s *TokenStore) GetByRefresh(refresh string) (ti models.TokenInfo, err error) {
